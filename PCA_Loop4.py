...
loop_file_path = "C:\\Users\\PHYS3009\\Desktop\\Chapter4\\Data_Preparation\\PCA\\Loop_Chla.xlsx"
loop_df = pd.read_excel(loop_file_path)
input_file_path = "C:\\Users\\PHYS3009\\Desktop\\Chapter4\\Data_Preparation\\PCA\\Chla_Indexes_Calculated_2.xlsx"
...
dependent_var = 'ChlA_ugL'
output_dir = "C:\\Users\\PHYS3009\\Desktop\\Chapter4\\Data_Preparation\\PCA\\Chla_Indexes"
...
for index, row in loop_df.iterrows():
    ...
    axs[index, 0].set_facecolor(chla_fill)
    ...
    for j, pc in enumerate(['PC1', 'PC2']):
        ...
        axs[index, j + 1].set_facecolor(chla_fill)
        

plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Chla_PCA_Plots.png"))
plt.savefig(os.path.join(output_dir, "Chla_PCA_Plots.svg"))